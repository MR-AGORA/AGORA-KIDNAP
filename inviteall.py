...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 1 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 2 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if smexxx:
        ...
        try:
            ...
            await wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 3 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 4 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 5 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 6 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 7 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 8 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 9 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 10 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 11 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 12 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 13 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 14 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 15 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 16 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 17 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 18 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 19 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 20 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 21 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 22 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 23 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 24 & Replace It. Join @Team_agora For Any Help")
    else:
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@Team_agora"))
            ...
            print(e)
            print("Check String 25 & Replace It. Join @Team_agora For Any Help")
    else:
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        await idk.send_message(
            e.chat_id, f"Hello Sir\nMy Agora Kidnapbot Command Handler ~ .\nI am client 1"
        )
...
@idk.on(events.NewMessage(incoming=True, pattern=r"\.Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        ...
        await krishna.edit(
            "**⚜️[Ͳєямιиαℓ Տτατυѕ](https://t.me/Team_agora)**\n\n`🔸Inviting Users.......`"
        )
        ...
        return await krishna.edit(
            f"[τєямנиαℓ ƒιиιѕнє∂](https://t.me/Team_agora) \n\n🔸 Sυϲϲєѕѕƒυℓℓγ ιиνιτє∂ `{s}` ρєορℓє \n⚠️ ƒαιℓє∂ το ιиνιτє `{f}` ρєορℓє"
        )


@ydk.on(events.NewMessage(incoming=True, pattern=r"\*Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        yukki = ("".join(event.text.split(maxsplit=1)[1:])).split(" ", 1)
        sender = await event.get_sender()
...
@wdk.on(events.NewMessage(incoming=True, pattern=r"\?Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@hdk.on(events.NewMessage(incoming=True, pattern=r"\+Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@sdk.on(events.NewMessage(incoming=True, pattern=r"\-Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@adk.on(events.NewMessage(incoming=True, pattern=r"\×Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@bdk.on(events.NewMessage(incoming=True, pattern=r"\÷Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@cdk.on(events.NewMessage(incoming=True, pattern=r"\=Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@edk.on(events.NewMessage(incoming=True, pattern=r"\.Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@ddk.on(events.NewMessage(incoming=True, pattern=r"\*Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@vkk.on(events.NewMessage(incoming=True, pattern=r"\?Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@kkk.on(events.NewMessage(incoming=True, pattern=r"\+Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@lkk.on(events.NewMessage(incoming=True, pattern=r"\-Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@mkk.on(events.NewMessage(incoming=True, pattern=r"\×Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@sid.on(events.NewMessage(incoming=True, pattern=r"\÷Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@shy.on(events.NewMessage(incoming=True, pattern=r"\=Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@aan.on(events.NewMessage(incoming=True, pattern=r"\.Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@ake.on(events.NewMessage(incoming=True, pattern=r"\*Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@eel.on(events.NewMessage(incoming=True, pattern=r"\?Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@khu.on(events.NewMessage(incoming=True, pattern=r"\+Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@shi.on(events.NewMessage(incoming=True, pattern=r"\-Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@yaa.on(events.NewMessage(incoming=True, pattern=r"\×Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@dav.on(events.NewMessage(incoming=True, pattern=r"\÷Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
@raj.on(events.NewMessage(incoming=True, pattern=r"\=Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        yukki = ("".join(event.text.split(maxsplit=1)[1:])).split(" ", 1)
        sender = await event.get_sender()
...
@put.on(events.NewMessage(incoming=True, pattern=r"\.Agora Kidnapbot"))
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        sender = await event.get_sender()
        me = await event.client.get_me()
...
text = """
CONGRATS 🥳🥳🥳 & SAY THANKS TO MR_AGORA (Mr_agora)
"""
